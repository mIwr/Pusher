  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: SafeArea(child: GestureDetector(onTap: () {
      ...
      SingleChildScrollView(physics: const BouncingScrollPhysics(), padding: const EdgeInsets.symmetric(horizontal: 16), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(padding: const EdgeInsets.fromLTRB(0, 16, 0, 8), child: Text(S.current.push_ctrl_panel_hms_project, style: primaryTextTheme.displaySmall)),
        ...
        Padding(padding: const EdgeInsets.fromLTRB(0, 16, 0, 8), child: Text(S.current.push_ctrl_panel_msg_payload, style: primaryTextTheme.displaySmall)),
            ...
            try {
              ...
              if (hmsResponse != null) {
                ...
                if (apiCode == HMSResponseCode.ok || apiCode == HMSResponseCode.partialOk) {
                  ...
                  msg += "Send fail";
                  if (err != null) {
                    msg += " - " + err.statusMsg + " (API code - " + hmsResponse.code.toString() + "; API msg - " + hmsResponse.msg + ')';
                  }
                }
              } else {
                msg += res.error?.apiError ?? "NULL response";
              }
